...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-16">
    <!-- Loading State -->
        ...
        <div class="col-span-1">
            <div class="sticky top-16 bg-white shadow-md rounded-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <button id="contact-seller" class="w-full bg-[#1b5d38] text-white px-4 py-2 rounded-md hover:bg-green-700 transition">Contact Seller</button>
                    <a href="{{route('properties')}}" class="block w-full bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 transition text-center">Back to Listings</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function renderPropertyData(property) {
        ...
        // Contact Seller Button (Placeholder action)
        document.getElementById('contact-seller').addEventListener('click', () => {
            alert('Contact seller feature coming soon!'); // Replace with actual contact logic
        });
    }
