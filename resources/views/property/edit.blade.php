...
@section('title','Edit Property Ad - Admin Panel')
@section('content')

<!-- Property Form -->
<div class="max-w-5xl mx-auto py-6" id="property-form-container">
    ...
    <form id="property-ad-form" enctype="multipart/form-data">
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6 border border-gray-200">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3" class="w-full border border-gray-300 rounded-md p-2"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6 border border-gray-200">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="address_line_1" id="address_line_1" class="w-full border border-gray-300 rounded-md p-2" required>
                    </div>
                </div>
                <div>
                    <label class="block text-gray-700 mb-1">Address Line 2</label>
                    <input type="text" name="address_line_2" id="address_line_2" class="w-full border border-gray-300 rounded-md p-2">
                </div>
                <div>
                    <label class="block text-gray-700 mb-1">City</label>
                    <input type="text" name="city" id="city" class="w-full border border-gray-300 rounded-md p-2" required>
                </div>
                <div>
                    <label class="block text-gray-700 mb-1">Province</label>
                    <input type="text" name="province" id="province" class="w-full border border-gray-300 rounded-md p-2" required>
                </div>
                <div>
                    <label class="block text-gray-700 mb-1">Postal Code</label>
                    <input type="text" name="postal_code" id="postal_code" class="w-full border border-gray-300 rounded-md p-2">
                </div>
            </div>
            ...
            <div class="type-residential grid grid-cols-2 gap-6 hidden">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="residential[bedrooms]" id="residential_bedrooms" class="w-full border rounded-md p-2 pl-12" placeholder="e.g. 3">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.5" name="residential[bathrooms]" id="residential_bathrooms" class="w-full border rounded-md p-2 pl-12" placeholder="e.g. 2.5">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="residential[floor_area]" id="residential_floor_area" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="residential[lot_size]" id="residential_lot_size" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="1800" max="2099" step="1" name="residential[year_built]" id="residential_year_built" class="w-full border rounded-md p-2 pl-10" placeholder="YYYY">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="residential[floors]" id="residential_floors" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 2">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="residential[parking_spaces]" id="residential_parking_spaces" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 1">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative flex items-center gap-2">
                        ...
                        <select name="residential[balcony]" id="residential_balcony" class="w-full border rounded-md p-2">
                ...
                <div>
                    ...
                    <div class="relative flex items-center gap-2">
                        ...
                        <select name="residential[heating_cooling]" id="residential_heating_cooling" class="w-full border rounded-md p-2">
            ...
            <div class="type-commercial grid grid-cols-2 gap-6 hidden">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="commercial[floor_area]" id="commercial_floor_area" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                        <span class="absolute right-2 top-2 text-gray-500 font-medium">sqft</span>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="commercial[number_of_floors]" id="commercial_number_of_floors" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 2">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="commercial[parking_spaces]" id="commercial_parking_spaces" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 5">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="commercial[power_capacity]" id="commercial_power_capacity" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="commercial[business_type]" id="commercial_business_type" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. Retail">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="commercial[loading_docks]" id="commercial_loading_docks" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 2">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" name="commercial[conference_rooms]" id="commercial_conference_rooms" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. 3">
                    </div>
                </div>
            ...
            <div class="type-industrial grid grid-cols-2 gap-6 hidden">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="industrial[total_area]" id="industrial_total_area" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                        <span class="absolute right-2 top-2 text-gray-500 font-medium">sqft</span>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="industrial[power_capacity]" id="industrial_power_capacity" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                        <span class="absolute right-2 top-2 text-gray-500 font-medium">kW</span>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="industrial[ceiling_height]" id="industrial_ceiling_height" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.1" name="industrial[floor_load_capacity]" id="industrial_floor_load_capacity" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <select name="industrial[crane_availability]" id="industrial_crane_availability" class="w-full border rounded-md p-2 pl-10">
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                        </select>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="industrial[waste_disposal]" id="industrial_waste_disposal" class="w-full border rounded-md p-2 pl-10" placeholder="e.g. On-site, Outsourced">
                    </div>
                </div>
            ...
            <div class="type-land grid grid-cols-2 gap-6 hidden">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.01" name="land[land_size]" id="land_land_size" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                        <span class="absolute right-2 top-2 text-gray-500 font-medium">sqft</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative flex items-center gap-2">
                        ...
                        <select name="land[zoning]" id="land_zoning" class="w-full border rounded-md p-2">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="0.01" name="land[road_frontage]" id="land_road_frontage" class="w-full border rounded-md p-2 pl-10 pr-16" placeholder="Enter value">
                ...
                <div>
                    ...
                    <div class="relative flex items-center gap-2">
                        ...
                        <select name="land[soil_type]" id="land_soil_type" class="w-full border rounded-md p-2">
        ...
        <button type="submit" class="bg-[#1b5d38] text-white px-4 py-2 rounded-md hover:bg-green-700 transition">Update Property Ad</button>
    </form>
</div>

<!-- JS Panel for changing selection -->
<div id="property-type-panel" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50 hidden">
    <div class="bg-white p-8 rounded-lg w-96 shadow-lg">
        <h2 class="text-xl font-semibold text-[#1b5d38] mb-4">Change Property Type</h2>
        <p class="text-gray-600 mb-4">Select a new property type. Note: Changing type may reset some fields.</p>
        <div class="mb-4">
        ...
        <button id="update-type" class="bg-[#1b5d38] text-white px-4 py-2 rounded-md hover:bg-green-700 transition w-full">Update</button>
    </div>
</div>
...
function initMap(lat, lng) {
    ...
    map = new google.maps.Map(document.getElementById("map"), { center: coords, zoom: 13 });
...
// Selection panel logic for changing type
const propertyTypePanel = document.getElementById('property-type-panel');
const updateTypeBtn = document.getElementById('update-type');
...
updateTypeBtn.addEventListener('click', () => {
    ...
    // Reset type-specific fields if changing type
    resetTypeFields(propType);
});
...
function resetTypeFields(type) {
    // Clear inputs for the new type
    document.querySelectorAll(`.type-${type} input, .type-${type} select, .type-${type} textarea`).forEach(el => {
        if (el.type === 'checkbox' || el.type === 'radio') el.checked = false;
        else el.value = '';
    });
    // Reset tags
    if (type === 'residential') selectedAmenities = [];
    if (type === 'commercial') selectedAccessibility = [];
    if (type === 'industrial') {
        selectedSafety = [];
        selectedRoads = [];
    }
    if (type === 'land') selectedUtilities = [];
    updateAllTags();
}
...
document.getElementById('property-ad-form').addEventListener('submit', function(e){
    ...
    .catch(err => {
        ...
        if(err.response?.data?.errors){
            ...
            alert('Failed to update property ad.');
        }
    });
});

// Amenities tag selection logic [residential]
...
const utilityOptions = document.querySelectorAll('.utility-option');
...
// Load property data and pre-fill
...
.then(res => {
    ...
    document.getElementById('title').value = propertyData.title || '';
    document.getElementById('description').value = propertyData.description || '';
    document.getElementById('address_line_1').value = propertyData.address_line_1 || '';
    document.getElementById('address_line_2').value = propertyData.address_line_2 || '';
    document.getElementById('city').value = propertyData.city || '';
    document.getElementById('province').value = propertyData.province || '';
    document.getElementById('postal_code').value = propertyData.postal_code || '';
    document.getElementById('latitude').value = propertyData.latitude || '';
    document.getElementById('longitude').value = propertyData.longitude || '';
    document.getElementById('price-field').value = propertyData.price || '';
    propertyTypeInput.value = propertyData.property_type || '';
    ...
    if (propertyData.residential) {
        document.getElementById('residential_bedrooms').value = propertyData.residential.bedrooms || '';
        document.getElementById('residential_bathrooms').value = propertyData.residential.bathrooms || '';
        document.getElementById('residential_floor_area').value = propertyData.residential.floor_area || '';
        document.getElementById('residential_lot_size').value = propertyData.residential.lot_size || '';
        document.getElementById('residential_year_built').value = propertyData.residential.year_built || '';
        document.getElementById('residential_floors').value = propertyData.residential.floors || '';
        document.getElementById('residential_parking_spaces').value = propertyData.residential.parking_spaces || '';
        document.getElementById('residential_balcony').value = propertyData.residential.balcony || '0';
        document.getElementById('residential_heating_cooling').value = propertyData.residential.heating_cooling || '';
        selectedAmenities = propertyData.residential.amenities ? JSON.parse(propertyData.residential.amenities) : [];
    }
    if (propertyData.commercial) {
        document.getElementById('commercial_floor_area').value = propertyData.commercial.floor_area || '';
        document.getElementById('commercial_number_of_floors').value = propertyData.commercial.number_of_floors || '';
        document.getElementById('commercial_parking_spaces').value = propertyData.commercial.parking_spaces || '';
        document.getElementById('commercial_power_capacity').value = propertyData.commercial.power_capacity || '';
        document.getElementById('commercial_business_type').value = propertyData.commercial.business_type || '';
        document.getElementById('commercial_loading_docks').value = propertyData.commercial.loading_docks || '';
        document.getElementById('commercial_conference_rooms').value = propertyData.commercial.conference_rooms || '';
        selectedAccessibility = propertyData.commercial.accessibility_features ? JSON.parse(propertyData.commercial.accessibility_features) : [];
    }
    if (propertyData.industrial) {
        document.getElementById('industrial_total_area').value = propertyData.industrial.total_area || '';
        document.getElementById('industrial_power_capacity').value = propertyData.industrial.power_capacity || '';
        document.getElementById('industrial_ceiling_height').value = propertyData.industrial.ceiling_height || '';
        document.getElementById('industrial_floor_load_capacity').value = propertyData.industrial.floor_load_capacity || '';
        document.getElementById('industrial_crane_availability').value = propertyData.industrial.crane_availability || '0';
        document.getElementById('industrial_waste_disposal').value = propertyData.industrial.waste_disposal || '';
        selectedRoads = propertyData.industrial.access_roads ? JSON.parse(propertyData.industrial.access_roads) : [];
        selectedSafety = propertyData.industrial.safety_certifications ? JSON.parse(propertyData.industrial.safety_certifications) : [];
    }
    if (propertyData.land) {
        document.getElementById('land_land_size').value = propertyData.land.land_size || '';
        document.getElementById('land_zoning').value = propertyData.land.zoning || '';
        document.getElementById('land_road_frontage').value = propertyData.land.road_frontage || '';
        document.getElementById('land_soil_type').value = propertyData.land.soil_type || '';
        selectedUtilities = propertyData.land.utilities ? JSON.parse(propertyData.land.utilities) : [];
    }

    updateAllTags();

    // Init map with existing lat/lng
    initMap(propertyData.latitude || 6.9271, propertyData.longitude || 79.8612);
